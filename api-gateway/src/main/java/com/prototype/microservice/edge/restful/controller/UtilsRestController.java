...
public class UtilsRestController extends BaseRestController {
    ...
    private void populateRandomString(final String type, final String length, final Integer count, RandomStringResponseDTO resp) {
        ...
        switch (type) {
            case ALPHANUMERIC:
                resp.setRandom(RandomStringUtils.randomAlphanumeric(count));
                break;
            case NUMERIC:
                resp.setRandom(RandomStringUtils.randomNumeric(count));
                break;
            case ALPHABETIC:
                resp.setRandom(RandomStringUtils.randomAlphabetic(count));
                break;
            default:
                resp.setRandom(RandomStringUtils.randomAlphanumeric(count));
        }
